		...
		<div class="container-fluid">
			...
			<div class="membership">
                ...
                <div class="add_update">
						<div class="add"><a href="addm_vendor.php">Add</a></div>
                        <div class="update"><a href="updatem_vendor.php">Update</a></div>
                </div>
            </div>
            <div class="managevendor">
                <div class="manage">Vendor<br>Management</div>
                <div class="add_update">
                        <div class="add"><a href="add_vendor.php">Add</a></div>
                        <div class="update"><a href="update_vendor.php">Update</a></div>
                </div>
            </div>
