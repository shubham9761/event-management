...
<body>
	<div class="main">
		...
		<div class="container-fluid">
			...
			<div class="sec">
				<div class="welcome abox">Manage Producs</div>
			...
			<div class="maintain">
				<div class="muser abox"><a href="insert_item.php">Insert</a></div>
				<div class="muser abox"><a href="delete_item.php">Delete</a></div>
			</div>
